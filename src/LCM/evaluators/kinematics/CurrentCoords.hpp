...
class CurrentCoords : public PHX::EvaluatorWithBaseImpl<Traits>, public PHX::EvaluatorDerived<EvalT, Traits>
{
 public:
  CurrentCoords(Teuchos::ParameterList const& p, const Teuchos::RCP<Albany::Layouts>& dl);
