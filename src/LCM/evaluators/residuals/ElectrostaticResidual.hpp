...
class ElectrostaticResidual : public PHX::EvaluatorWithBaseImpl<Traits>, public PHX::EvaluatorDerived<EvalT, Traits>
{
 public:
  ...
  /// Constructor
  ///
  ElectrostaticResidual(Teuchos::ParameterList& p, const Teuchos::RCP<Albany::Layouts>& dl);
