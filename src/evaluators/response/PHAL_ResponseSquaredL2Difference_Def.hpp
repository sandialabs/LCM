...
PHAL::ResponseSquaredL2DifferenceBase<EvalT, Traits, SourceScalarT, TargetScalarT>::ResponseSquaredL2DifferenceBase(
...
template <typename EvalT, typename Traits, typename SourceScalarT, typename TargetScalarT>
void
PHAL::ResponseSquaredL2DifferenceBase<EvalT, Traits, SourceScalarT, TargetScalarT>::postRegistrationSetup(
...
template <typename EvalT, typename Traits, typename SourceScalarT, typename TargetScalarT>
void
PHAL::ResponseSquaredL2DifferenceBase<EvalT, Traits, SourceScalarT, TargetScalarT>::preEvaluate(typename Traits::PreEvalData workset)
{
...
template <typename EvalT, typename Traits, typename SourceScalarT, typename TargetScalarT>
void
PHAL::ResponseSquaredL2DifferenceBase<EvalT, Traits, SourceScalarT, TargetScalarT>::evaluateFields(typename Traits::EvalData workset)
{
  ...
  for (int cell = 0; cell < workset.numCells; ++cell) {
    ...
    for (int qp = 0; qp < numQPs; ++qp) {
      ...
      switch (fieldDim) {
        case 0: sq += std::pow(sourceField(cell, qp) - (target_value ? target_value_val : targetField(cell, qp)), 2); break;
        case 1:
          for (int j = 0; j < dims[2]; ++j) sq += std::pow(sourceField(cell, qp, j) - (target_value ? target_value_val : targetField(cell, qp, j)), 2);
          break;
        case 2:
          for (int j = 0; j < dims[2]; ++j)
            for (int k = 0; k < dims[3]; ++k) sq += std::pow(sourceField(cell, qp, j, k) - (target_value ? target_value_val : targetField(cell, qp, j, k)), 2);
          break;
      }
...
template <typename EvalT, typename Traits, typename SourceScalarT, typename TargetScalarT>
void
PHAL::ResponseSquaredL2DifferenceBase<EvalT, Traits, SourceScalarT, TargetScalarT>::postEvaluate(typename Traits::PostEvalData workset)
{
...
template <typename EvalT, typename Traits, typename SourceScalarT, typename TargetScalarT>
int
PHAL::ResponseSquaredL2DifferenceBase<EvalT, Traits, SourceScalarT, TargetScalarT>::getLayout(
    const Teuchos::RCP<Albany::Layouts>& dl,
