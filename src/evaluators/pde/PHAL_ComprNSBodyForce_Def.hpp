...
ComprNSBodyForce<EvalT, Traits>::ComprNSBodyForce(Teuchos::ParameterList const& p)
...
template <typename EvalT, typename Traits>
void
ComprNSBodyForce<EvalT, Traits>::evaluateFields(typename Traits::EvalData workset)
{
  if (bf_type == NONE) {
