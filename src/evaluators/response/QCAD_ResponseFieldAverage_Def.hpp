...
QCAD::ResponseFieldAverage<EvalT, Traits>::ResponseFieldAverage(
    ...
    : coordVec("Coord Vec", dl->qp_vector), weights("Weights", dl->qp_scalar)
{
  ...
  std::string local_response_name = fieldName + " Local Response Field Average";
...
template <typename EvalT, typename Traits>
void
QCAD::ResponseFieldAverage<EvalT, Traits>::postRegistrationSetup(
...
template <typename EvalT, typename Traits>
void
QCAD::ResponseFieldAverage<EvalT, Traits>::preEvaluate(
...
template <typename EvalT, typename Traits>
void
QCAD::ResponseFieldAverage<EvalT, Traits>::evaluateFields(
...
template <typename EvalT, typename Traits>
void
QCAD::ResponseFieldAverage<EvalT, Traits>::postEvaluate(
