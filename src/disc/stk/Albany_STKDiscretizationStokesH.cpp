...
STKDiscretizationStokesH::STKDiscretizationStokesH(
...
void
STKDiscretizationStokesH::computeGraphs()
{
  ...
  const LayeredMeshNumbering<LO>& layeredMeshNumbering =
