...
QCAD::ResponseCenterOfMass<EvalT, Traits>::ResponseCenterOfMass(
...
template <typename EvalT, typename Traits>
void
QCAD::ResponseCenterOfMass<EvalT, Traits>::postRegistrationSetup(
...
template <typename EvalT, typename Traits>
void
QCAD::ResponseCenterOfMass<EvalT, Traits>::preEvaluate(
...
template <typename EvalT, typename Traits>
void
QCAD::ResponseCenterOfMass<EvalT, Traits>::evaluateFields(
...
template <typename EvalT, typename Traits>
void
QCAD::ResponseCenterOfMass<EvalT, Traits>::postEvaluate(
...
QCAD::ResponseCenterOfMass<EvalT, Traits>::getValidResponseParameters() const
{
  ...
  validPL->set<std::string>(
      "Field Name", "", "Scalar field from which to compute center of mass");
  validPL->set<std::string>(
      "Description",
      "",
