...
{
 public:
  TsunamiBoussinesq1DSolitaryWave(
      int                    neq_,
      int                    numDim_,
...
{
 public:
  AerasHydrostaticBaroclinicInstabilities(
      int                    neq_,
      int                    numDim_,
      Teuchos::Array<double> data_);
  void
...
{
 public:
  AerasHydrostaticPureAdvection1(
      int                    neq_,
      int                    numDim_,
      Teuchos::Array<double> data_);
  void
...
{
 public:
  AerasHydrostatic3dDeformationalFlow(
      int                    neq_,
      int                    numDim_,
      Teuchos::Array<double> data_);
  void
...
{
 public:
  AerasXZHydrostaticGaussianBall(
      int                    neq_,
      int                    numDim_,
      Teuchos::Array<double> data_);
  void
...
{
 public:
  AerasXZHydrostaticGaussianBallInShear(
      int                    neq_,
      int                    numDim_,
      Teuchos::Array<double> data_);
  void
...
{
 public:
  AerasXZHydrostaticGaussianVelocityBubble(
      int                    neq_,
      int                    numDim_,
      Teuchos::Array<double> data_);
  void
...
class AerasTC3Init : public AnalyticFunction
{
 ...
 private:
  double
  bx(const double x);  // an indicator function

  double
  ucomponent(const double lon);  // unrotated u-comp in TC3
...
class AerasTCGalewskyInit : public AnalyticFunction
{
 ...
 private:
  double
  ucomponent(const double lon);  //
  double
  hperturb(const double lon, const double lat);  //
...
class AerasTC4Init : public AnalyticFunction
{
 ...
 private:
  ...
  double
  phicon(const double lat);
  double
  bubfnc(const double lat);
  double
  dbubf(const double lat);
};
