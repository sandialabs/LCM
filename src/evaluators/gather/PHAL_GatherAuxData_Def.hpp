...
GatherAuxData<EvalT, Traits>::GatherAuxData(Teuchos::ParameterList const& p, const Teuchos::RCP<Albany::Layouts>& dl)
{
...
template <typename EvalT, typename Traits>
void
GatherAuxData<EvalT, Traits>::postRegistrationSetup(typename Traits::SetupData d, PHX::FieldManager<Traits>& fm)
{
