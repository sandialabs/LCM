...
CapPlasticityExplicitFD<EvalT, Traits>::CapPlasticityExplicitFD(Teuchos::ParameterList* p, const Teuchos::RCP<Albany::Layouts>& dl)
...
template <typename EvalT, typename Traits>
void
CapPlasticityExplicitFD<EvalT, Traits>::computeState(typename Traits::EvalData workset, DepFieldMap dep_fields, FieldMap eval_fields)
{
...
// all local functions
template <typename EvalT, typename Traits>
typename CapPlasticityExplicitFD<EvalT, Traits>::ScalarT
// typename EvalT::ScalarT
CapPlasticityExplicitFD<EvalT, Traits>::compute_f(minitensor::Tensor<ScalarT>& sigma, minitensor::Tensor<ScalarT>& alpha, ScalarT& kappa)
{
  xi = sigma - alpha;
...
template <typename EvalT, typename Traits>
minitensor::Tensor<typename CapPlasticityExplicitFD<EvalT, Traits>::ScalarT>
CapPlasticityExplicitFD<EvalT, Traits>::compute_dfdsigma(minitensor::Tensor<ScalarT>& sigma, minitensor::Tensor<ScalarT>& alpha, ScalarT& kappa)
{
  xi = sigma - alpha;
...
template <typename EvalT, typename Traits>
minitensor::Tensor<typename CapPlasticityExplicitFD<EvalT, Traits>::ScalarT>
CapPlasticityExplicitFD<EvalT, Traits>::compute_dgdsigma(minitensor::Tensor<ScalarT>& sigma, minitensor::Tensor<ScalarT>& alpha, ScalarT& kappa)
{
  xi = sigma - alpha;
...
template <typename EvalT, typename Traits>
typename CapPlasticityExplicitFD<EvalT, Traits>::ScalarT
CapPlasticityExplicitFD<EvalT, Traits>::compute_dfdkappa(minitensor::Tensor<ScalarT>& sigma, minitensor::Tensor<ScalarT>& alpha, ScalarT& kappa)
{
  ScalarT dfdkappa;
...
template <typename EvalT, typename Traits>
typename CapPlasticityExplicitFD<EvalT, Traits>::ScalarT
CapPlasticityExplicitFD<EvalT, Traits>::compute_Galpha(ScalarT& J2_alpha)
{
  if (N != 0)
...
template <typename EvalT, typename Traits>
minitensor::Tensor<typename CapPlasticityExplicitFD<EvalT, Traits>::ScalarT>
CapPlasticityExplicitFD<EvalT, Traits>::compute_halpha(minitensor::Tensor<ScalarT>& dgdsigma, ScalarT& J2_alpha)
{
...
template <typename EvalT, typename Traits>
typename CapPlasticityExplicitFD<EvalT, Traits>::ScalarT
CapPlasticityExplicitFD<EvalT, Traits>::compute_dedkappa(ScalarT& kappa)
{
