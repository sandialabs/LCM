...
if(DEFINED MPIMNP AND ${MPIMNP} GREATER 1)
  SET(EXODIFF_TEST0 ${SEACAS_EXODIFF} -i -m ${OUTPUT_FILENAME0} ${REF_FILENAME0})
  SET(EXODIFF_TEST1 ${SEACAS_EXODIFF} -i -m ${OUTPUT_FILENAME1} ${REF_FILENAME1})
ELSE()
  SET(EXODIFF_TEST0 ${SEACAS_EXODIFF} -i ${OUTPUT_FILENAME0} ${REF_FILENAME0})
  SET(EXODIFF_TEST1 ${SEACAS_EXODIFF} -i ${OUTPUT_FILENAME1} ${REF_FILENAME1})
ENDIF()
#if(DEFINED MPIMNP AND ${MPIMNP} GREATER 1)
