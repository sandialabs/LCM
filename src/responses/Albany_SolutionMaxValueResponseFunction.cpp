...
SolutionMaxValueResponseFunction::SolutionMaxValueResponseFunction(const Teuchos::RCP<Teuchos_Comm const>& comm, int neq_, int eq_, bool interleavedOrdering_)
