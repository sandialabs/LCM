...
class SurfaceScalarJump : public PHX::EvaluatorWithBaseImpl<Traits>, public PHX::EvaluatorDerived<EvalT, Traits>
{
 public:
  SurfaceScalarJump(Teuchos::ParameterList const& p, const Teuchos::RCP<Albany::Layouts>& dl);
