        ...
        int                            offsetToFirstDOF) const
{
  ...
  p->set<Teuchos::ArrayRCP<std::string>>(
      "Time Dependent Solution Names", dof_names_dot);
        ...
        int                            offsetToFirstDOF) const
{
  ...
  if (dof_names_dotdot != Teuchos::null) {
    p->set<Teuchos::ArrayRCP<std::string>>(
        "Solution Acceleration Names", dof_names_dotdot);
        ...
        std::string const& field_name) const
{
  ...
  return rcp(
      new PHAL::GatherScalarExtruded2DNodalParameter<EvalT, Traits>(*p, dl));
}
        ...
        std::string const& field_name) const
{
  ...
  p->set<int>("Field Level", 0);
  return rcp(
      new PHAL::ScatterScalarExtruded2DNodalParameter<EvalT, Traits>(*p, dl));
}
        ...
        std::string                              scatterName) const
{
  ...
  RCP<ParameterList> p = rcp(new ParameterList("Scatter Residual"));
  p->set<Teuchos::ArrayRCP<std::string>>("Residual Names", resid_names);
  p->set<Teuchos::RCP<std::map<std::string, int>>>(
      "Extruded Params Levels", extruded_params_levels);
  ...
  return rcp(
      new PHAL::ScatterResidualWithExtrudedParams<EvalT, Traits>(*p, dl));
}
        ...
        std::string const&                                   sideSetName) const
{
  ...
  // Input: X, Y at vertices
  p->set<std::string>(
      "Coordinate Vector Vertex Name", "Coord Vec " + sideSetName);
  ...
  // Output: X, Y at Quad Points (same name as input)
  return rcp(new PHAL::MapToPhysicalFrameSide<EvalT, Traits>(
      *p, dl->side_layouts.at(sideSetName)));
}
        ...
        int                offsetToFirstDOF) const
{
  ...
  RCP<ParameterList> p =
      rcp(new ParameterList("DOF Grad Interpolation " + dof_name));
  // Input
  ...
  if (offsetToFirstDOF == -1) {
    return rcp(
        new PHAL::DOFGradInterpolationBase<EvalT, Traits, ScalarType>(*p, dl));
  } else  // works only for solution or a set of solution components
    return rcp(
        new PHAL::FastSolutionGradInterpolationBase<EvalT, Traits, ScalarType>(
            *p, dl));
}
        ...
        std::string const& sideSetName) const
{
  ...
  RCP<ParameterList> p =
      rcp(new ParameterList("DOF Grad Interpolation Side " + dof_name));
  ...
  return rcp(new PHAL::DOFGradInterpolationSideBase<EvalT, Traits, ScalarType>(
      *p, dl->side_layouts.at(sideSetName)));
}
        ...
        int                offsetToFirstDOF) const
{
  ...
  RCP<ParameterList> p =
      rcp(new ParameterList("DOF Interpolation " + dof_name));
  // Input
  p->set<std::string>("Variable Name", dof_name);
        ...
        std::string const& sideSetName) const
{
  ...
  RCP<ParameterList> p =
      rcp(new ParameterList("DOF Interpolation Side " + dof_name));
  // Input
  p->set<std::string>("Variable Name", dof_name);
  p->set<std::string>("BF Name", "BF " + sideSetName);
  p->set<std::string>("Side Set Name", sideSetName);
  ...
  return rcp(new PHAL::DOFInterpolationSideBase<EvalT, Traits, ScalarType>(
      *p, dl->side_layouts.at(sideSetName)));
}
        ...
        int                offsetToFirstDOF) const
{
  ...
  RCP<ParameterList> p =
      rcp(new ParameterList("DOFTensor Interpolation " + dof_name));
  // Input
  p->set<std::string>("Variable Name", dof_name);
  p->set<std::string>("BF Name", "BF");
  p->set<int>("Offset of First DOF", offsetToFirstDOF);
  ...
  // Output (assumes same Name as input)
  if (offsetToFirstDOF == -1)
    return rcp(new PHAL::DOFTensorInterpolationBase<EvalT, Traits, ScalarType>(
        *p, dl));
  else  // works only for solution or a set of solution components
    return rcp(
        new PHAL::
            FastSolutionTensorInterpolationBase<EvalT, Traits, ScalarType>(
                *p, dl));
}
        ...
        int                offsetToFirstDOF) const
{
  ...
  RCP<ParameterList> p =
      rcp(new ParameterList("DOFTensorGrad Interpolation " + dof_name));
  // Input
  p->set<std::string>("Variable Name", dof_name);
  p->set<std::string>("Gradient BF Name", "Grad BF");
  p->set<int>("Offset of First DOF", offsetToFirstDOF);
  ...
  if (offsetToFirstDOF == -1)
    return rcp(
        new PHAL::DOFTensorGradInterpolationBase<EvalT, Traits, ScalarType>(
            *p, dl));
  else  // works only for solution or a set of solution components
    return rcp(
        new PHAL::
            FastSolutionTensorGradInterpolationBase<EvalT, Traits, ScalarType>(
                *p, dl));
}
        ...
        int                offsetToFirstDOF) const
{
  ...
  RCP<ParameterList> p =
      rcp(new ParameterList("DOFVecGrad Interpolation " + dof_name));
  // Input
  p->set<std::string>("Variable Name", dof_name);
  p->set<std::string>("Gradient BF Name", "Grad BF");
  p->set<int>("Offset of First DOF", offsetToFirstDOF);
  ...
  if (offsetToFirstDOF == -1)
    return rcp(new PHAL::DOFVecGradInterpolationBase<EvalT, Traits, ScalarType>(
        *p, dl));
  else  // works only for solution or a set of solution components
    return rcp(
        new PHAL::
            FastSolutionVecGradInterpolationBase<EvalT, Traits, ScalarType>(
                *p, dl));
}
        ...
        std::string const& sideSetName) const
{
  ...
  return rcp(
      new PHAL::DOFVecGradInterpolationSideBase<EvalT, Traits, ScalarType>(
          *p, dl->side_layouts.at(sideSetName)));
}
        ...
        int                offsetToFirstDOF) const
{
  ...
  RCP<ParameterList> p =
      rcp(new ParameterList("DOFVec Interpolation " + dof_name));
  // Input
  p->set<std::string>("Variable Name", dof_name);
  p->set<std::string>("BF Name", "BF");
  p->set<int>("Offset of First DOF", offsetToFirstDOF);
  ...
  if (offsetToFirstDOF == -1)
    return rcp(
        new PHAL::DOFVecInterpolationBase<EvalT, Traits, ScalarType>(*p, dl));
  else  // works only for solution or a set of solution components
    return rcp(
        new PHAL::FastSolutionVecInterpolationBase<EvalT, Traits, ScalarType>(
            *p, dl));
}
        ...
        std::string const& sideSetName) const
{
  ...
  RCP<ParameterList> p =
      rcp(new ParameterList("DOF Vec Interpolation Side " + dof_name));
  ...
  return rcp(new PHAL::DOFVecInterpolationSideBase<EvalT, Traits, ScalarType>(
      *p, dl->side_layouts.at(sideSetName)));
}
        ...
        bool               isVectorField) const
{
  ...
  p = Teuchos::rcp(new Teuchos::ParameterList(
      "DOF Nodes to Cell Interpolation " + dof_name));
  ...
  return Teuchos::rcp(
      new PHAL::NodesToCellInterpolationBase<EvalT, Traits, ScalarType>(
          *p, dl));
}
        ...
        const Teuchos::RCP<PHX::DataLayout> cell_layout) const
{
  Teuchos::RCP<Teuchos::ParameterList> p;
  p = Teuchos::rcp(new Teuchos::ParameterList(
      "DOF QuadPoint to Cell Interpolation " + dof_name));
  ...
  if ((qp_layout == Teuchos::null) && (cell_layout == Teuchos::null))
    return Teuchos::rcp(
        new PHAL::QuadPointsToCellInterpolationBase<EvalT, Traits, ScalarType>(
            *p, dl, dl->qp_scalar, dl->cell_scalar2));
  else
    return Teuchos::rcp(
        new PHAL::QuadPointsToCellInterpolationBase<EvalT, Traits, ScalarType>(
            *p, dl, qp_layout, cell_layout));
}
        ...
        int const          fieldDim) const
{
  ...
  Teuchos::RCP<Teuchos::ParameterList> p;
  p = Teuchos::rcp(new Teuchos::ParameterList(
      "DOF Side QuadPoint to Side Interpolation " + dof_name));

  // Input
  p->set<std::string>("Field QP Name", dof_name);
  p->set<std::string>(
      "Weighted Measure Name", "Weighted Measure " + sideSetName);
  p->set<std::string>("Side Set Name", sideSetName);
  ...
  return Teuchos::rcp(
      new PHAL::
          SideQuadPointsToSideInterpolationBase<EvalT, Traits, ScalarType>(
              *p, dl->side_layouts.at(sideSetName)));
}
