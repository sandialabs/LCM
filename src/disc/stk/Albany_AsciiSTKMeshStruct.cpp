      ...
      bf(nullptr)
{
  ...
  // assumes surface height file is called "sh" and its first row is the number
  // of nodes
  ...
  // assumes mesh file is called "eles" and its first row is the number of
  // elements
  ...
  // assumes basal face connectivity file is called "bf" and its first row is
  // the number of faces on basal boundary
  ...
  if ((numProc == 1) &
    ...
    for (int i = 0; i < NumEles; i++) {
      ...
      // globalElesID[i] << std::endl;
            ...
            // This file should have a header like the other files, and length
            // NumEles.
  ...
  // assumes flow factor file is called "flwa" and its first row is the number
  ...
  // assumes temperature file is called "temp" and its first row is the number
  // of elements in the mesh
  ...
  // assumes basal friction file is called "beta" and its first row is the
  // number of nodes
