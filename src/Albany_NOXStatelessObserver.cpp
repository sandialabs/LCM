...
NOXStatelessObserver::NOXStatelessObserver(
...
void
NOXStatelessObserver::observeSolution(const Epetra_Vector& solution)
{
  observeSolution(solution, impl->getTimeParamValueOrDefault(0.0));
}

void
NOXStatelessObserver::observeSolution(
    const Epetra_Vector& solution,
    double               time_or_param_val)
{
  Teuchos::RCP<const Epetra_Vector> solution_ptr =
