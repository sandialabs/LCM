...
without modification; exercising the full erosion loop (part
changes, workset rebuilds) under the ACE solver is part of the ACE
workflow integration (Phase 3), which remains, along with the
ocean-exposure weakening and depth profiles.
