...
class GatherEigenvectors : public PHX::EvaluatorWithBaseImpl<Traits>, public PHX::EvaluatorDerived<EvalT, Traits>
{
 public:
  GatherEigenvectors(Teuchos::ParameterList const& p, const Teuchos::RCP<Albany::Layouts>& dl);
