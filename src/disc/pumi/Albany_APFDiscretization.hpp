...
class APFDiscretization : public AbstractDiscretization
{
 public:
  ...
  getNodeVectorSpace(const std::string& /* field_name */) const override
  {
    TEUCHOS_TEST_FOR_EXCEPTION(
        true,
        std::logic_error,
        "Albany::APFDiscretization: getNodeVectorSpace(field_name) not "
        "implemented yet");
  ...
  getOverlapNodeVectorSpace(const std::string& /* field_name */) const override
  {
    TEUCHOS_TEST_FOR_EXCEPTION(
        true,
        std::logic_error,
        "Albany::APFDiscretization: getOverlapNodeVectorSpace(field_name) not "
        "implemented yet");
    TEUCHOS_UNREACHABLE_RETURN(Teuchos::null);
  }
  ...
  getVectorSpace(const std::string& /* field_name */) const override
  {
    TEUCHOS_TEST_FOR_EXCEPTION(
        true,
        std::logic_error,
        "Albany::APFDiscretization: getVectorSpace(field_name) not implemented "
        "yet");
    TEUCHOS_UNREACHABLE_RETURN(Teuchos::null);
  }
  ...
  getOverlapVectorSpace(const std::string& /* field_name */) const override
  {
    TEUCHOS_TEST_FOR_EXCEPTION(
        true,
        std::logic_error,
        "Albany::APFDiscretization: getOverlapVectorSpace(field_name) not "
        "implemented yet");
    TEUCHOS_UNREACHABLE_RETURN(Teuchos::null);
  }
  ...
  Teuchos::RCP<Thyra_LinearOp>
  createImplicitJacobianOp() const override
  {
    return m_jac_factory->createOp();
  }
  Teuchos::RCP<Thyra_LinearOp>
  createImplicitOverlapJacobianOp() const override
  {
    return m_overlap_jac_factory->createOp();
  }
#endif
  ...
  getSideToSideSetCellMap() const override
  {
    TEUCHOS_TEST_FOR_EXCEPTION(
        true,
        std::logic_error,
        "Error! Functionality not supported by APF discretization.\n");
  ...
  //! Set stateArrays
  void
  setStateArrays(StateArrays& sa) override
  {
    stateArrays = sa;
    return;
  }
  ...
  {
    return meshStruct->hasRestartSolution;
  }
  ...
  {
    return meshStruct->restartDataTime;
  }
  ...
  void
  updateMesh(bool shouldTransferIPData, Teuchos::RCP<ParamLib> paramLib);
  ...
  GO
  getDOF(const GO inode, const int entry, int total_comps = -1) const
  {
  ...
  getOverlapDOFManager(const std::string& /* field_name */) const override
  {
    TEUCHOS_TEST_FOR_EXCEPTION(
        true,
        std::logic_error,
        "APFDiscretization: getOverlapDOFManager(field_name) not implemented "
        "yet");
  }
  ...
  std::vector<std::vector<apf::MeshEntity*>>&
  getBuckets()
  {
    return buckets;
  }
  ...
  Teuchos::Array<std::string> const&
  getResNames()
  {
    return resNames;
  }
  ...
  apf::DynamicArray<apf::Node> const&
  getOwnedNodes()
  {
    return ownedNodes;
  }
  ...
  //   virtual Teuchos::RCP<const Epetra_Map> getMap() const override { return
  //   map; } virtual Teuchos::RCP<const Epetra_Map> getOverlapMap() const
  //   override { return overlap_map; } virtual Teuchos::RCP<const Epetra_Map>
  //   getOverlapNodeMap() const override; virtual Teuchos::RCP<const
  //   Epetra_CrsGraph> getJacobianGraph() const override { return graph; }
  //   virtual Teuchos::RCP<const Epetra_CrsGraph> getOverlapJacobianGraph()
  //   const override { return overlap_graph; } virtual Teuchos::RCP<const
  //   Epetra_Map> getNodeMap() const override {
  ...
  getSolutionField(const bool overlapped) const override;
  Teuchos::RCP<Thyra_MultiVector>
  getSolutionMV(const bool overlapped) const override;

#if defined(ALBANY_LCM)
  void
  setResidualField(const Thyra_Vector& residual) override;
#endif
      ...
      const std::string& /* field_name */) const override
  {
    TEUCHOS_TEST_FOR_EXCEPTION(
        true,
        std::logic_error,
        "Error! Method not yet implemented in APFDiscretization.\n";)
  }
  void
  setField(
  ...
  void
  writeAnySolutionToMeshDatabase(
      const ST*  soln,
      const int  index,
      const bool overlapped);
  void
  writeAnySolutionToFile(const double time);

  void
  writeRestartFile(const double time);
 ...
 public:
  ...
  void
  copyQPScalarToAPF(unsigned nqp, std::string const& state, apf::Field* f);
  void
  copyQPVectorToAPF(unsigned nqp, std::string const& state, apf::Field* f);
  void
  copyQPTensorToAPF(unsigned nqp, std::string const& state, apf::Field* f);
  void
  copyQPStatesToAPF(apf::FieldShape* fs, bool copyAll = true);
  void
 ...
 protected:
  ...
  // Side set discretizations related structures (not supported but needed for
  ...
  // States: vector of length num worksets of a map from field name to shards
  // array
