...
template <typename T, index_t Order>
KOKKOS_INLINE_FUNCTION BasicTensor<T, Order>::~BasicTensor()
{
  // delete[] data_;
}
...
template <typename T, index_t Order>
KOKKOS_INLINE_FUNCTION typename BasicTensor<T, Order>::iterator
...
template <typename T, index_t Order>
KOKKOS_INLINE_FUNCTION typename BasicTensor<T, Order>::const_iterator
...
KOKKOS_INLINE_FUNCTION typename BasicTensor<T, Order>::value_type
...
template <typename T, index_t Order>
template <typename... Indices>
KOKKOS_INLINE_FUNCTION typename BasicTensor<T, Order>::reference
