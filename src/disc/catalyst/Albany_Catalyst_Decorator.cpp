...
Decorator::Decorator(
    ...
    : discretization(discretization_), timestep(0)
{
  Adapter::initialize(catalystParams_);
}

Decorator::~Decorator() { Adapter::cleanup(); }

Teuchos::RCP<const Epetra_Map>
Decorator::getMap() const
{
  return discretization->getMap();
}

Teuchos::RCP<const Tpetra_Map>
Decorator::getMapT() const
{
  return discretization->getMapT();
}

Teuchos::RCP<const Tpetra_Map>
Decorator::getMapT(const std::string& field_name) const
{
  return discretization->getMapT(field_name);
}

Teuchos::RCP<const Tpetra_Map>
Decorator::getOverlapMapT() const
{
  return discretization->getOverlapMapT();
}

Teuchos::RCP<const Tpetra_Map>
Decorator::getOverlapMapT(const std::string& field_name) const
{
  return discretization->getOverlapMapT();
}

Teuchos::RCP<const Epetra_Map>
Decorator::getOverlapMap() const
{
  return discretization->getOverlapMap();
}

Teuchos::RCP<const Epetra_CrsGraph>
Decorator::getJacobianGraph() const
{
  return discretization->getJacobianGraph();
}

Teuchos::RCP<const Tpetra_CrsGraph>
Decorator::getJacobianGraphT() const
{
...
#ifdef ALBANY_AERAS
Teuchos::RCP<const Tpetra_CrsGraph>
Decorator::getImplicitJacobianGraphT() const
{
...
Teuchos::RCP<const Tpetra_CrsGraph>
Decorator::getOverlapJacobianGraphT() const
{
...
#ifdef ALBANY_AERAS
Teuchos::RCP<const Tpetra_CrsGraph>
Decorator::getImplicitOverlapJacobianGraphT() const
{
...
Teuchos::RCP<const Epetra_Map>
Decorator::getNodeMap() const
{
  return discretization->getNodeMap();
}

Teuchos::RCP<const Tpetra_Map>
Decorator::getNodeMapT() const
{
  return discretization->getNodeMapT();
}

Teuchos::RCP<const Tpetra_Map>
Decorator::getNodeMapT(const std::string& field_name) const
{
  return discretization->getNodeMapT();
}
...
Teuchos::RCP<const Epetra_Map>
Decorator::getOverlapNodeMap() const
{
...
Teuchos::RCP<const Tpetra_Map>
Decorator::getOverlapNodeMapT() const
{
  return discretization->getOverlapNodeMapT();
}

bool
Decorator::isExplicitScheme() const
{
  return discretization->isExplicitScheme();
}

Teuchos::RCP<const Tpetra_Map>
Decorator::getOverlapNodeMapT(const std::string& field_name) const
{
  return discretization->getOverlapNodeMapT();
}

const NodeSetList&
Decorator::getNodeSets() const
{
  return discretization->getNodeSets();
}

const NodeSetGIDsList&
Decorator::getNodeSetGIDs() const
{
  return discretization->getNodeSetGIDs();
}

const NodeSetCoordList&
Decorator::getNodeSetCoords() const
{
  return discretization->getNodeSetCoords();
}

const SideSetList&
Decorator::getSideSets(const int workset) const
{
...
void
Decorator::setReferenceConfigurationManager(
...
Decorator::getContactManager() const
{
...
Decorator::getSphereVolume() const
{
  return discretization->getSphereVolume();
}

const WorksetArray<Teuchos::ArrayRCP<double*>>::type&
Decorator::getLatticeOrientation() const
{
  return discretization->getLatticeOrientation();
}

void
Decorator::printCoords() const
{
  discretization->printCoords();
}

const Decorator::SideSetDiscretizationsType&
Decorator::getSideSetDiscretizations() const
{
  return discretization->getSideSetDiscretizations();
}

const std::map<std::string, std::map<GO, GO>>&
Decorator::getSideToSideSetCellMap() const
{
...
#ifdef ALBANY_EPETRA
void
Decorator::writeSolution(
    const Epetra_Vector& soln,
    const double         time,
    const bool           overlapped)
{
  Adapter* adapter = Adapter::get();
  if (adapter) adapter->update(this->timestep++, time, *this, soln);
...
Decorator::newVtkUnstructuredGrid()
{
...
Decorator::getSolutionField(bool overlapped) const
{
  return discretization->getSolutionField(overlapped);
}

Teuchos::RCP<Tpetra_Vector>
Decorator::getSolutionFieldT(bool overlapped) const
{
  return discretization->getSolutionFieldT(overlapped);
}

Teuchos::RCP<Tpetra_MultiVector>
Decorator::getSolutionMV(bool overlapped) const
{
  return discretization->getSolutionMV(overlapped);
}

void
Decorator::getFieldT(Tpetra_Vector& field_vector, const std::string& field_name)
    const
{
...
bool
Decorator::hasRestartSolution() const
{
  return discretization->hasRestartSolution();
}

bool
Decorator::supportsMOR() const
{
...
double
Decorator::restartDataTime() const
{
  return discretization->restartDataTime();
}

int
Decorator::getNumDim() const
{
  return discretization->getNumDim();
}

int
Decorator::getNumEq() const
{
...
#ifdef ALBANY_LCM
void
Decorator::setResidualField(const Thyra_Vector& residual)
{
  /* TODO: should react to this */
...
Decorator::writeSolution(
    ...
    const Epetra_Vector& solution_dot,
    const double         time,
    const bool           overlapped)
{
  /* TODO: should react to this */
...
void
Decorator::writeSolutionToMeshDatabaseT(
    const Tpetra_Vector& solutionT,
    const double         time,
    const bool           overlapped)
{
...
void
Decorator::writeSolutionMVToMeshDatabase(
    const Tpetra_MultiVector& solutionT,
    const double              time,
    const bool                overlapped)
{
...
void
Decorator::writeSolutionToFileT(
    const Tpetra_Vector& solutionT,
    const double         time,
    const bool           overlapped)
{
...
void
Decorator::writeSolutionMVToFile(
    const Tpetra_MultiVector& solutionT,
    const double              time,
    const bool                overlapped)
{
...
Decorator::getLayeredMeshNumbering()
{
