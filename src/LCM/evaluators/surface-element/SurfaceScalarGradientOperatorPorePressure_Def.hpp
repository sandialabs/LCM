      ...
      grad_val_qp(p.get<std::string>("Surface Scalar Gradient Name"), dl->qp_gradient)
{
  ...
  this->setName("Surface Scalar Gradient Operator Pore Pressure" + PHX::print<EvalT>());
...
template <typename EvalT, typename Traits>
void
SurfaceScalarGradientOperatorPorePressure<EvalT, Traits>::evaluateFields(typename Traits::EvalData workset)
{
