...
template <typename EvalT, typename Traits>
void
CahnHillChemTerm<EvalT, Traits>::postRegistrationSetup(typename Traits::SetupData d, PHX::FieldManager<Traits>& fm)
{
...
template <typename EvalT, typename Traits>
void
CahnHillChemTerm<EvalT, Traits>::evaluateFields(typename Traits::EvalData workset)
{
