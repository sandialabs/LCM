 ...
 * implementations (e.g., Epetra vs Tpetra), we implementa a very light-weight
 ...
 * graph are hidden, as is the concrete linear algebra package underneath. The
 * global function 'Albany::build_type' is used to determine in which format the
 * graph has to be stored.
 */
