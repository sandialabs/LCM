...
1. The simplest is to use a constant permittivity across the entire domain (one
element block, one material), say with a value of 5.0. In this case, one would
declare at the "Problem" level, that a constant permittivity was being used, and
its value was 5.0:
