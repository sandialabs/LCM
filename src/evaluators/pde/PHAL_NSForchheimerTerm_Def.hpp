...
template <typename EvalT, typename Traits>
void
NSForchheimerTerm<EvalT, Traits>::postRegistrationSetup(typename Traits::SetupData d, PHX::FieldManager<Traits>& fm)
{
...
template <typename EvalT, typename Traits>
void
NSForchheimerTerm<EvalT, Traits>::evaluateFields(typename Traits::EvalData workset)
{
