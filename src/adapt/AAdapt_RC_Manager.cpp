...
template <>
void
Manager::createEvaluators<PHAL::AlbanyTraits::Residual>(
    PHX::FieldManager<PHAL::AlbanyTraits>& fm,
      ...
      const PHX::MDField<RealType, Cell, QuadPoint, Dim>& coord_qp)
  {
    ...
    for (int i = 0; i < 2; ++i) {
      ...
      a.assign(
          ...
          (size_t)f_mdf.dimension(1),
          (size_t)f_mdf.dimension(2),
