...
struct LayeredMeshNumbering
{
  ...
  void
  getIndices(const T id, T& column_id, T& level_index) const
  {
...
struct AbstractMeshStruct
{
 ...
 public:
  ...
  getMeshSpecs() = 0;
  virtual const Teuchos::ArrayRCP<Teuchos::RCP<Albany::MeshSpecsStruct>>&
  getMeshSpecs() const = 0;
