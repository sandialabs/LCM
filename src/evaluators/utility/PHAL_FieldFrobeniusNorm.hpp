...
using FieldFrobeniusNorm =
    FieldFrobeniusNormBase<EvalT, Traits, typename EvalT::ScalarT>;

template <typename EvalT, typename Traits>
using FieldFrobeniusNormMesh =
    FieldFrobeniusNormBase<EvalT, Traits, typename EvalT::MeshScalarT>;

template <typename EvalT, typename Traits>
using FieldFrobeniusNormParam =
    FieldFrobeniusNormBase<EvalT, Traits, typename EvalT::ParamScalarT>;
