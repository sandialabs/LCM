...
class StaticPointer
{
 public:
  ...
  StaticPointer<T>&
  operator=(StaticPointer<T>&& other);
  StaticPointer<T>&
  operator=(const StaticPointer<T>&) = delete;
  ...
  template <typename U>
  friend bool
  operator==(const StaticPointer<U>& lhs, const StaticPointer<U>& rhs);
...
template <typename T>
StaticPointer<T>::StaticPointer() : ptr_(nullptr)
{
}

template <typename T>
StaticPointer<T>::StaticPointer(std::nullptr_t) : ptr_(nullptr)
{
}

template <typename T>
StaticPointer<T>::StaticPointer(T* ptr) : ptr_(ptr)
{
}
...
template <std::size_t Size>
StaticStackAllocator<Size>::StaticStackAllocator() : ptr_(buffer_)
{
}
